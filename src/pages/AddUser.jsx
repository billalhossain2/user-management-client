...
const AddUser = () => {
  return (
    <div>
        <Header></Header>
        <Link to="/">
        <p><i class="fa-solid fa-arrow-left-long me-2 my-3"></i><span>All Users</span></p>
        </Link>
        <div className='bg-[#ece8e8] py-5 flex flex-col items-center'>
            <div className='text-center my-5'>
            <h3 className='text-2xl font-semibold mb-2'>New User</h3>
            <p className='text-[16px] text-[#615d5d]'>Use the below form to create a new user</p>
            </div>
            <form className='w-[60%] mx-atuo p-3 space-y-4'>
                ...
                <div>
                    <button className='bg-[#16DB93] w-[100%] rounded-sm p-2 text-white font-bold'>Add A New User</button>
                </div>
            </form>
        </div>
    </div>
